...
class EnterYourStartWeightViewController: UIViewController {
    // MARK: - Outlets
    ...
    @IBAction func addButton(_ sender: Any) {
        if mainTextField.text != "" {
            ...
            if Double(mainTextField.text!) != nil {
                ...
                UserDefaults.standard.set(weightNumber, forKey: "valueFromStartTextField")
            }  else {
                showAllert("Please, fill in the field only with numbers and a dot!")
            }
        } else {
            showAllert("Fill your start weight!")
        }
...
extension EnterYourStartWeightViewController: UITextViewDelegate {
